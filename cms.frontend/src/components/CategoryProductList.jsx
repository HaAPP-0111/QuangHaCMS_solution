...
const CategoryProductList = () => {
    // 1. State lưu trữ danh sách danh mục sản phẩm trả về từ API
    const [categoryProducts, setCategoryProducts] = useState([]);
    // 2. State quản lý trạng thái loading trong lúc đợi API phản hồi
    const [loading, setLoading] = useState(true);

    // 3. useEffect tự động chạy một lần sau khi Component được mount
    useEffect(() => {
